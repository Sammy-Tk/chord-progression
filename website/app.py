...
st.markdown("### Select your chords")
...
chord_roots = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'A#', 'C#', 'D#', 'F#', 'G#', 'Ab', 'Bb', 'Db', 'Eb', 'Gb']
chord_qualities = ['', 'm', '7']
# all_chords = [note + quality for note in chord_roots for quality in chord_qualities]
...
with st.form("chord_form"):
    ...
    if submit_button:
        ...
        st.success(f"Added chord: {selected_chord}")
